...
<div class="col-md-6">
    <div class="app-title">
        <div>
            <h4><i class="fa fa-th-list"></i>Edit Teacher</h4>
        </div>
    ...
    <div class="panel panel-flat" >
        ...
        <!-- //start form area  -->
            ...
            <g:if test = "${ editProvince != null}">
                <div id="banks">
                    <g:each var="pro" in="${editProvince}">
                        ...
                        <hr/>
                        <br/>
                        <g:form url = "[action: 'updateProvince',controller:'updateProvince']"  method="post" class="form-horizontal" style='margin-top: -27px;'>
